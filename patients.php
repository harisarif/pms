...
if ($patientName != '' && $address != '' &&
  $cnic != '' && $dateBirth != '' && $phoneNumber != '' && $gender != '') {
    ...
    header("Location:congratulation.php?goto_page=patients.php&message=$message&already_exists=1");
}
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <a href="#" class = "btn btn-danger btn-sm btn-flat" onclick="myFunction(<?= $row['id']?>)">
...
<script>
  ...
  function addHyphen (element) {
    ...
    function myFunction(id) {
      let text;
      let person = prompt("Please enter reason:", "Urgent work");
      if (person == null || person == "") {
        text = "User cancelled the prompt.";
        return false;
      } else {
        text = "Hello " + person ;
        window.location.href="delete-patient.php?del="+id+"&reason="+person;
      }

...
if(isset($_POST['save_medicine'])) {
  ...
  if($medicineName != '') {
   $query = "INSERT INTO `medicines`(`medicine_name`,`medicine_type`)
   VALUES('$medicineName','$medicineType');";
...
try {
  $query = "select `id`, `medicine_name`,`medicine_type` from `medicines` 
...
<head>
 ...
 <title>Medicines - Hope Clinic in PHP</title>
</head>
            ...
            <form method="post">
             <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                ...
                <input type="text" id="medicine_type" name="medicine_type" required="required"
                class="form-control form-control-sm rounded-0" />
              </div>

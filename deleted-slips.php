...
`phone_number`, `gender`,`father_name`,`slipNumber`, reason
FROM `deleted_slips`  order by `patient_name` asc;";
 ...
 <section class="content">
      ...
      <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">Deleted Slips</h3>
...
<script>
  showMenuSelected("#deleted-slips", "#deleted-slips");
